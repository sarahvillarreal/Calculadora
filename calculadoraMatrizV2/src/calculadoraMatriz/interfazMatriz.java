...
public class interfazMatriz implements ActionListener {
    ...
    public void operaciones() {
        ...
        jbDeterminante = new JButton(new ImageIcon("src/imagenes/multimulti.png"));
        jbInversa = new JButton(new ImageIcon("src/imagenes/multimulti.png"));
        jbDivision = new JButton(new ImageIcon("src/imagenes/multimulti.png"));
        ...
        jbDeterminante.setBounds(5, 260, 40, 33);
        jbInversa.setBounds(5, 300, 40, 33);
        jbDivision.setBounds(5, 340, 40, 33);
    ...
    public void actionPerformed(ActionEvent e) {
            ...
            if (jTMatriz1 != null) {
                if (chMatriz11.getSelectedIndex() == chMatriz12.getSelectedIndex()) {
                	if (chMatriz12.getSelectedIndex() >= 1 && chMatriz12.getSelectedIndex() <= 3) {
                		...
                		temp = operaciones.determinanteMatriz(tomarValores(jTMatriz1));
                        ventanaRespuesta resp = new ventanaRespuesta(temp);
        ...
        } else if (e.getSource() == jbInversa) {//evento boton para obtener determinante de una matriz
